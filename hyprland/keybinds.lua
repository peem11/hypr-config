...
hl.bind("SUPER + X", hl.dsp.global("quickshell:overviewClipboardToggle"))
...
hl.bind("SUPER + Z", hl.dsp.global("quickshell:regionScreenshot"), { description = "Utilities: Screen snip" })
hl.bind("SUPER + Z",
